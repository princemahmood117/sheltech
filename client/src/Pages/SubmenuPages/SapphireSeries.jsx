...
import sapphireProjectsData from "./sapphireProjectsData";


const SapphireSeries = () => {
  ...
  return (
    <div>
      <Helmet>
        <title>Sheltec Projects | Commercial</title>
      </Helmet>
      ...
      {!isLoading && (
        <div className="mb-9">
          <div className="w-screen h-screen relative overflow-hidden m-0 p-0">
            {/* Background Image */}
            <img
              src="https://www.sheltech-bd.com/cms/admin/uploads/page/projects/17326195293SCf9.jpeg"
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center space-y-4">
              ...
              <h1
                ...
                Boost Your Business Right Here
              </h1>
            </div>
          </div>
            ...
            <div className="w-full min-h-screen bg-white py-8 px-4">
              <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                  {sapphireProjectsData.map((project) => (
                    <div
                      key={project.id}
