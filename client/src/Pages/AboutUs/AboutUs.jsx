...
const AboutUs = () => {
  return (
    <div className="min-h-screen mb-9">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
            ...
            <div className="space-y-6">
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                ...
                estate developers in Bangladesh. Since our inception in 1988, we
                have been dedicated to creating innovative living spaces that
                combine luxury, comfort, and sustainability.
              </p>
              <p className="text-lg text-gray-700 leading-relaxed">
                With over three decades of experience, we have successfully
                completed numerous residential and commercial projects, earning
                the trust of thousands of families and businesses across the
                country.
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-20">
            ...
            <div className="bg-gray-50 p-8 rounded-lg">
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                superior construction quality, and exceptional customer service.
              </p>
            </div>
            ...
            <div className="bg-gray-50 p-8 rounded-lg">
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                creating sustainable communities that set new standards in
          ...
          <div className="mb-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  Our customers' happiness and satisfaction is our top priority.
                </p>
              </div>
            </div>
          </div>
